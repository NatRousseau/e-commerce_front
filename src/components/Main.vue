<template>
    <div>
        <div class="jumbotron text-center">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque consequuntur distinctio esse explicabo
                labore
                minus nisi repudiandae sequi vel? Assumenda consectetur eos et, ex ipsam laboriosam magnam sapiente
                vitae
                voluptas!</p>
        </div>
        <div class="container">
...
<!--                        <img v-else  :src="product.filename" alt="" class="card-img-top"-->
<!--                             style="width: 100%; height: auto;">-->
                        <div class="card-body">
                            <h5 class="card-title">
